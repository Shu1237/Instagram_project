  ...
  return (
    <div className="cursor-pointer h-auto overflow-hidden scrollbar-hide scroll-smooth">
      ...
      <div className="w-[350] min-h-[350px]  border p-6 shadow-lg rounded-2xl hover:bg-[#F2F2F2] overflow-hidden  mb-4 ">
        ...
        <div className="flex flex-col gap-4 mb-3">
          ...
          <p className="text-gray-500">
            Manage your connected experiences and account setting across Meta
            technologies.
          </p>
      ...
      <div className="flex flex-col ">
        ...
        <div
          onClick={() => setClick(1)}
          className={`flex flex-row gap-4 h-14 p-4  rounded-xl hover:bg-[#EFEFEF]   ${
            click === 1 ? "bg-[#EFEFEF] " : " bg-white"
          }    `}
        >
          <svg
            aria-label=""
