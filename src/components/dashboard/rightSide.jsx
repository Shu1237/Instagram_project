                    ...
                    <div className="flex items-center gap-6">
                        <div className="relative ">
                            {avatar?.preview ? (
                                ...
                                <img
                                    className="w-20 h-20 rounded-full object-cover border-4 border-white shadow-lg"
                                    src=""  // Update with your default image path
                                    alt="Dell coanh "
                                />
                            )}

                            <div className='absolute w-4 h-4 rounded-2xl bg-green-400 right-1 bottom-1 '>

                            </div>
                        </div>
                        <div>
                            <h2 className="text-xl font-bold text-gray-800">Chi_kai123</h2>
                            <div className='flex flex-row items-center gap-2'>
                                <p className="text-gray-500">{profile.name}</p>
                                <p className={`${profile.status === 'Active' ? 'text-green-500 font-semibold' : 'text-gray-500'} p-2 `}>
                ...
                {isEditing ? (
                    ...
                    <div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                            ...
                            <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl">
                                <TransgenderOutlinedIcon className="text-gray-500" />
                                <div>
