        ...
        <div className='container'>
          ...
          <div className="comment-container">
            ...
            {arryTyms.map((item, index) => (
              <div className='comment-container' key={index}>
                <div className='body'>
                  ...
                  <div className="icon-heart" onClick={() => handleHeartClick(index)}>
                    {isLiked[index] ? (
            ...
            <div className='add-comment'>
              ...
              <div>
                {value ? (
                  <button style={{ color: '#1880af',
                    border: 'none',
                    background: 'rgba(35, 32, 32, 0)' }}>Post</button>
                ) : (
                  <button style={{ color: '#9595a2',
                      border: 'none',
                      background: '#23202000' }} disabled>Post</button>
                )}
              </div>
            </div>
